...
export default class TableList extends PureComponent {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'wenumlist/setGetWeNumUserGroupList',
      payload: params,
    });
    dispatch({
  ...
  handleAdd = fields => { //添加分组
    const { dispatch } = this.props;
    dispatch({
      type: 'wenumlist/setCreatWeNumUserGroup',
      payload: fields
    });
  ...
  render() {
    ...
    const columns = [
      {
        title: '分组ID',
        dataIndex: 'WeNum_Group_id',
       
       
      },
      {
        title: '分组名称',
        dataIndex: 'WeNum_Group_name',
      ...
      // }
      {
        ...
        render: val => (
          <Fragment>
            <a href={`#/WeNum/lists/GroupInfo?GroupId=${val}`}>人员列表</a>
    ...
    return (
      <PageHeaderWrapper title="公众号分组列表">
        <Card bordered={false}>
