export default {
  ...
  'menu.Order.OlderOrder': 'Older Order',
  'menu.Order.OlderOrder.OlderOrderCenter': 'Older Order Center',
  'menu.Order.OlderOrder.CreatOlderOrder': 'Creat Older Order',
  'menu.Order.OlderHome': 'OlderHome',
  'menu.Order.OlderHome.OlderHomeList': 'OlderHomeList',
  'menu.Order.OlderHome.CreatOlderHomeCenter': 'CreatOlderHomeCenter',
  'menu.Order.OlderHome.OlderHomeOrderList': 'OlderHomeOrderList',
  'menu.Order.OlderOrder.OlderOrderCenterXJDW': 'OlderOrderCenter(上级单位)',
  'menu.Order.OlderOrder.OlderOrderCenterBDW': 'OlderOrderCenter(本单位)',
  'menu.Order.OlderOrder.OlderOrderCenterFWRY': 'OlderOrderCenter(服务人员)',
  'menu.Order.OlderOrder.AdminUserOrderList': 'AdminUserOrderList',
  'menu.Order.OlderOrder.AdminUserOrderInfo': 'AdminUserOrderInfo',
  'menu.ModeMsgAdmin': 'ModeMsgAdmin',
  'menu.ModeMsgAdmin.ModeMsg': 'ModeMsgSend',
  //微信小程序管理 英语部分
  'menu.weapp': 'Weapp Admin',
  'menu.weapp.activity': 'Weapp Admin activitys',
  'menu.weapp.activity.act-admin': 'release activitys',
  'menu.weapp.activity.activityList': 'Act list',
  'menu.weapp.activity.act-admin.weapp-act-admin-info': 'Act Info',
  'menu.weapp.activity.act-admin.weapp-act-admin-confirm': 'Act Confirm',
  'menu.weapp.activity.act-admin.weapp-act-admin-result': 'Act Result',
  'menu.weapp.activity.act-admin.weapp-act-admin': 'Act Admin',
  'menu.weapp.welfare': 'welfare',
  'menu.weapp.welfare.CreatNewWelfare': 'CreatNewWelfare',
  //轮播
  'menu.weapp.weapp-Lunbo': 'Weapp Lunbo Admin',
  //小程序管理菜单结束
  //小程序用户列表开始
  'menu.weapp.lists': 'User Admin',
  'menu.weapp.lists.UserList': 'Weapp UserList',
  'menu.weapp.lists.Userinfo': 'Weapp Userinfo',
  //小程序用户列表完成
  //微信公众平台用户开始
  'menu.WeNum': 'WeNum Admin',
  'menu.WeNum.lists': 'WeNum Admin Lists',
  'menu.WeNum.lists.UserList': 'WeNum Admin UserList',
  'menu.WeNum.lists.UserInfo': 'WeNum Admin UserInfo',
  'menu.WeNum.lists.GroupList': 'WeNum User Group List',
  'menu.WeNum.lists.GroupInfo': 'WeNum Group User List Info',
  //微信公众平台用户结束
  //管理系统开始
  'menu.AdminSystem': 'AdminSystem Administration',
  'menu.AdminSystem.AuthSystem': 'Auth Administration',
  'menu.AdminSystem.AuthSystem.UnitManageList': 'UnitManageList Administration',
  'menu.AdminSystem.AuthSystem.RoleManageList': 'RoleManageList Administration',
  'menu.AdminSystem.AuthSystem.RoleManageInfo': 'RoleManageInfo Administration',
  'menu.AdminSystem.AuthSystem.UserManageList': 'UserManageList Administration',
  'menu.AdminSystem.AuthSystem.DepartmentList': 'DepartmentList Administration',
  'menu.AdminSystem.AuthSystem.DepartmentListSJ': 'DepartmentListSJ Administration',
  'menu.AdminSystem.AuthSystem.DepartmentInfo': 'DepartmentList UserList',
  //管理系统结束
  'menu.form': 'Form',
  ...
  'app.settings.binding.QXbind': 'Cancel Bind',
  'app.settings.binding.wechat': 'Binding wechat',
  'app.settings.binding.wechat-description-not': 'Currently unbound wechat account',
  'app.settings.binding.wechat-description': 'Currently bound wechat account',
  ...
  'menu.account.settings_zuzhi': '切换组织',
};
